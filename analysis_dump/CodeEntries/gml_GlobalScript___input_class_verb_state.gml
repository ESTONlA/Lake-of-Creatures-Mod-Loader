function __input_class_verb_state() constructor
{
    ...
    static tick = function(arg0)
    {
        ...
        if (global.__input_toggle_momentary_state && type == UnknownEnum.Value_0 && variable_struct_exists(global.__input_toggle_momentary_dict, name))
        {
        ...
        if (global.__input_cooldown_state && type == UnknownEnum.Value_0 && variable_struct_exists(global.__input_cooldown_dict, name))
        {
